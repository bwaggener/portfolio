...
Next i want to remove variables I don't need for my analysis. That includes everything except for the sociaty ratings ("LFLH" and so on) and the political ideology measures. I am taking out the immigration societies to simplify it further (we decided to not analyzing those societies).
