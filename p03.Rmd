...
# Run the regression model with both two-way and three-way interactions
family_model <- lm(Society_Rating ~ avrg_pol_score * Happiness * Family_Values, data = long_ideal_society %>%
              filter(!is.na(Family_Values)))
