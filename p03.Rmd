...
Here i transformed the data from wide to long and recoded the societies so that those with nontraditional family values (LF) are coded as 0 and traditional- (HF) are coded as 1. 
