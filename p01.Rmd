...
Filtering out responses that were not collected through Prolific.
``` {r cleaningdata_2}
...
Removing one response from the data because their free response was not thoughtful enought. 
```{r cleaningdata_3}
